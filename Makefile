...
run: venv
	...
	venv/bin/python -m vim_turing_machine.machines.merge_business_hours.merge_business_hours '[[1,6],[6,7]]' 3
...
build-vim: venv
	...
	venv/bin/python -m vim_turing_machine.machines.merge_business_hours.vim_merge_business_hours '[[1,6],[6,7]]' 3
